        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">@lang('features')</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('/admin')}}">@lang('home')</a>
                                </li>
                                <li class="breadcrumb-item"><a
                                        href="{{url('/admin/features')}}">@lang('features')</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="head-label">
                                    <h4 class="card-title">@lang('features')</h4>
                                </div>
...
@section('scripts')
    <script>
        var url = '{{url(app()->getLocale()."/admin/features")}}/';
        ...
        var oTable = $('#datatable').DataTable({
            ...
            searching: false,
            ajax: {
                url: '{{ url(app()->getLocale().'/admin/features/indexTable')}}',
                data: function (d) {
                    d.name = $('#s_name').val();
                }
            },
            columns: [
                ...
                {
                    "render": function (data, type, full, meta) {
                        return `<img width="50" height="50" src="` + full.icon + `" class="avatar avatar-sm me-3" alt="user1">`;
                    }
                },
                {data: 'feature_name', name: 'name'},
        ...
        $(document).ready(function () {
            $(document).on('click', '.edit_btn', function (event) {
                ...
                @endforeach
                $('#edit_src_icon').attr('src', button.data('icon'))
            });
