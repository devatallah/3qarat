        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">@lang('countries')</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('/admin')}}">@lang('home')</a>
                                </li>
                                <li class="breadcrumb-item"><a
                                        href="{{url('/admin/countries')}}">@lang('countries')</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <form action="" id="edit_form" method="POST"
                        ...
                        <div class="row">
                            ...
                            @endforeach
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="edit_order">@lang('order')</label>
                                        <input type="number" class="form-control"
                                               placeholder="@lang('order')"
                                               name="order" id="edit_order">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                                <div class="col-12">
...
@section('scripts')
    <script>
        var url = '{{url(app()->getLocale()."/admin/countries")}}/';
        ...
        var oTable = $('#datatable').DataTable({
            ...
            searching: false,
            ajax: {
                url: '{{ url(app()->getLocale().'/admin/countries/indexTable')}}',
                data: function (d) {
                    d.name = $('#s_name').val();
                }
            },
