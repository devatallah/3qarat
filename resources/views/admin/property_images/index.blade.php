        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">@lang('property_images')</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('/admin')}}">@lang('home')</a>
                                </li>
                                <li class="breadcrumb-item"><a
                                        href="{{url('/admin/property_images')}}">@lang('property_images')</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="head-label">
                                    <h4 class="card-title">@lang('property_images') <b>@lang('name'): </b>{{$property->name}} <b> @lang('code'): </b>{{$property->code}}</h4>
                                </div>
                                    ...
                                    <div class="fileinput fileinput-exists"
                                        ...
                                        <div>
                                                    <span class="btn btn-secondary btn-file">
                                                        ...
                                                        <input type="file" multiple name="image[]"></span>
                                        </div>
...
{{--
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="edit_images">@lang('images')</label>
                                    <input type="file" accept="image/*" class="form-control"
                                           multiple placeholder="@lang('images')"
                                           name="images" id="edit_images">
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
--}}
...
@section('scripts')
    <script>
        var url = '{{url(app()->getLocale()."/admin/property_images")}}/';
        ...
        var oTable = $('#datatable').DataTable({
            ...
            searching: false,
            ajax: {
                url: '{{ url(app()->getLocale().'/admin/property_images/indexTable')}}',
                data: function (d) {
                    d.property_uuid = '{{$property->uuid}}';
                }
            },
            columns: [
                {
