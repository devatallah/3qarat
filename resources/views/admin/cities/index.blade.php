        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">@lang('cities')</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('/admin')}}">@lang('home')</a>
                                </li>
                                <li class="breadcrumb-item"><a
                                        href="{{url('/admin/cities')}}">@lang('cities')</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="head-label">
                                    <h4 class="card-title">@lang('cities')</h4>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <select class="country_uuid form-control" id="s_country_uuid">
                        ...
                        <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="edit_country_uuid form-control" id="edit_country_uuid" name="country_uuid" required>
                                            <option value="">@lang('select')</option>
                                            @foreach($countries as $country)
                                                <option value="{{$country->uuid}}">{{$country->name}}</option>
                                            @endforeach
...
@section('scripts')
    <script>
        var url = '{{url(app()->getLocale()."/admin/cities")}}/';
        ...
        var oTable = $('#datatable').DataTable({
            ...
            searching: false,
            ajax: {
                url: '{{ url(app()->getLocale().'/admin/cities/indexTable')}}',
                data: function (d) {
                    d.name = $('#s_name').val();
        ...
        $(document).ready(function () {
            $(document).on('click', '.edit_btn', function (event) {
                ...
                var country_uuid = button.data('country_uuid')
                $('#edit_form').attr('action', url + uuid)
                @foreach(locales() as $key => $value)
                $('#edit_name_{{$key}}').val(button.data('name_{{$key}}'))
                @endforeach
                $('#edit_country_uuid').val(country_uuid).trigger('change')
            });
